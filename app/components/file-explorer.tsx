...
const files: TwinFile[] = [
  ...
  { id: "renewal-term", name: "renewal.md", path: "source-twin/terms/renewal.md", tag: "shared term", description: "Renewal gives cancellation and renewal logic one agreed meaning for the same product event.", content: `---\nid: renewal\n---\n# Renewal\n\nThe date when a subscription begins its next paid period or a scheduled cancellation takes effect.` },
...
export function FileExplorer() {
  ...
  const groups = [
    ...
    { label: "terms/", ids: ["subscription-term", "cancellation-term", "renewal-term"] },
